function boid = updateboid(dim,n,boid,prd,pred,coe,zor,zop,fov,k,velLim,velCorr,vM)
...
% velLim  = limit on the boid velocity
% velCorr = correction velocity if the boid moves outside bounds
% vM      = vision mode of the boids
%
% OUTPUTS:
