...
% The changes made in this function are related to an increase in the
% velocity of the boids when they hit the wall. This was done to reduce the
% possibility that a boid hits the wall too slow and the bouncing velocity
% was also too slow (taking too much time to move towards the flock)
